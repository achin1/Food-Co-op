...
CREATE TABLE members (id INTEGER PRIMARY KEY AUTOINCREMENT, first_name TEXT, last_name TEXT, email_address TEXT, last_signup_date NUMERIC, membership_length NUMERIC, membership_type NUMERIC, year_in_school NUMERIC, recieve_email NUMERIC, is_active NUMERIC);
